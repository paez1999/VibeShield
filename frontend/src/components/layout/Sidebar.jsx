...
const NAV = [
  ...
  { to: '/dashboard/integrations',label: 'Integrations', dot: 'var(--amber)',  badge: null },
  { to: '/dashboard/breaches',    label: 'Breaches',     dot: 'var(--red)',    badge: null },
  { to: '/dashboard/moderation',  label: 'Moderation',   dot: 'var(--purple)', badge: null },
]
  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        <span style={{ fontFamily: 'var(--font-disp)', fontWeight: 800, fontSize: '15px', color: '#fff' }}>
          VibeShield
        </span>
      </div>
      ...
      <div style={{ padding: '12px 0 0' }}>
        <div style={{ padding: '4px 16px 8px', fontSize: '10px', color: 'var(--muted)', letterSpacing: '2px' }}>
          PANEL
        </div>
      ...
      <div style={{ marginTop: 'auto', borderTop: '1px solid var(--border)', padding: '12px 16px' }}>
        <button
          ...
          style={{
            ...
            color: 'var(--muted)', fontSize: '11px', padding: '7px',
